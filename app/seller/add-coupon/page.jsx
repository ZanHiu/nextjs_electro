...
const AddCoupon = () => {
  ...
  return (
    <div className="p-5">
      <h1 className="text-2xl font-semibold mb-5">Thêm mã giảm giá mới</h1>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Mã giảm giá sẽ được tạo tự động với format: {formData.prefix}XXXX
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {formData.type === "PERCENTAGE"
                ? "Nhập số phần trăm giảm giá (0-100)"
