  ...
  useEffect(() => {
    const verifyPayment = async () => {
      try {
        ...
        const orderId = vnp_OrderInfo.replace('Thanh toan cho ma GD:', '').trim();
  ...
  if (showSuccess) {
    return (
      <div className='h-screen flex flex-col justify-center items-center gap-5'>
        ...
        <div className="text-center text-2xl font-semibold">Đơn hàng đã được thanh toán thành công!</div>
        <p className="text-gray-600">Đang chuyển hướng đến trang đơn hàng của bạn...</p>
      </div>
    );
  }
